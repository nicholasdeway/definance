...
export const fixedExpenseCategories = [
  { key: "aluguel", label: "Aluguel", icon: Home, placeholder: "R$ 1.500,00" },
  { key: "luz", label: "Energia", icon: Zap, placeholder: "R$ 200,00" },
  { key: "agua", label: "Água", icon: Droplets, placeholder: "R$ 80,00" },
  { key: "internet", label: "Internet", icon: Globe, placeholder: "R$ 120,00" },
  { key: "celular", label: "Celular", icon: Smartphone, placeholder: "R$ 80,00" },
  { key: "streaming", label: "Streaming", icon: Clapperboard, placeholder: "R$ 50,00" },
  { key: "academia", label: "Academia", icon: Dumbbell, placeholder: "R$ 100,00" },
  { key: "transporte", label: "Transporte", icon: Bus, placeholder: "R$ 200,00" },
...
export const vehicleTypes = [
  ...
  { key: "bike_eletrica", label: "Bike Elét.", icon: Bike },
  { key: "scooter", label: "Scooter", icon: Scooter },
  { key: "moto", label: "Moto", icon: Motorbike },
  { key: "carro", label: "Carro", icon: Car },
  { key: "suv_picape", label: "SUV/Picape", icon: CarFront },
  { key: "van", label: "Van", icon: Bus },
  { key: "caminhao", label: "Caminhão", icon: Truck },
  { key: "trator", label: "Trator", icon: Tractor },
  { key: "lancha", label: "Lancha", icon: Ship },
  { key: "jetski", label: "Jetski", icon: Ship },
  { key: "helicoptero", label: "Helicóptero", icon: Helicopter },
  { key: "aeronave", label: "Aeronave", icon: Plane },
  { key: "outro", label: "Outro", icon: Plus },
]
...
export const ONBOARDING_ERRORS = {
  ...
  vehicles: {
    ...
    insuranceIncomplete: (index: number) => `Informe o valor da parcela do seguro para o veículo número ${numberToWords(index)}`,
    ipvaIncomplete: (index: number) => `Informe o ano base e os dados das parcelas de IPVA para o veículo número ${numberToWords(index)}`,
    ipvaInvalidYear: (index: number) => `Informe um ano válido para o IPVA do veículo número ${numberToWords(index)}`,
  },
  debts: {
