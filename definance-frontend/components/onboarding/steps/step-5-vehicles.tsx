              ...
              <AccordionTrigger className="hover:no-underline px-4 sm:px-6 py-4 sm:py-5 group data-[state=open]:pb-2">
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3 sm:gap-4 text-left">
                    <div className={cn(
                      "flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-xl sm:rounded-2xl text-xl transition-all shadow-sm ring-1 ring-border/20 dark:ring-white/10",
                      isExpanded ? "bg-primary text-primary-foreground scale-105" : "bg-muted dark:bg-white/5 text-muted-foreground"
                    )}>
                ...
                <div className="pt-2 space-y-5 sm:space-y-6">
                  ...
                  <div className="grid gap-3 sm:gap-4 sm:grid-cols-2">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className={cn(
                          "h-8 sm:h-9 bg-muted/30 dark:bg-white/[0.03] border-border/50 dark:border-white/10 text-xs sm:text-sm font-medium sm:font-semibold rounded-lg sm:rounded-xl transition-all focus:bg-muted/40 dark:focus:bg-white/[0.05]",
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-8 sm:h-9 bg-muted/30 dark:bg-white/[0.03] border-border/50 dark:border-white/10 text-xs sm:text-sm font-medium sm:font-semibold rounded-lg sm:rounded-xl transition-all focus:bg-muted/40 dark:focus:bg-white/[0.05]"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 sm:space-y-5 border-t border-white/5 pt-4 sm:pt-5 mt-2">
                    <div className="flex items-center gap-2 px-1">
                      ...
                      <span className="h-px flex-1 bg-border/50 dark:bg-white/5" />
                    </div>
                                ...
                                <div className="flex items-center gap-2 w-full sm:w-auto flex-1">
                                  <div className="flex-1 min-w-0">
                                    <DatePicker
                                      ...
                                      size="sm"
                                      className="h-7 bg-white/[0.03] border-white/10 w-full"
