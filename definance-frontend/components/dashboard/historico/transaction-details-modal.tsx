      ...
      <div className="space-y-4 md:space-y-8 pt-6 sm:pt-0">
        ...
        <div className="space-y-3 md:space-y-4">
          {(transaction.descricao || isMobile) && (
            <div className="p-3 md:p-4 rounded-xl md:rounded-2xl bg-muted/10 border border-border/50 space-y-1.5 md:space-y-2">
        ...
        <div className="pt-4 md:pt-6 border-t border-border/50 flex items-center gap-2 md:gap-3">
          <Button
            variant="ghost"
            className="flex-1 h-10 md:h-12 rounded-xl md:rounded-2xl font-bold text-destructive hover:bg-destructive/10 hover:text-destructive border border-destructive/10 text-xs md:text-sm cursor-pointer"
            onClick={onDelete}
          >
          ...
          <Button
            className="flex-[2] h-10 md:h-12 rounded-xl md:rounded-2xl font-bold bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all text-xs md:text-sm cursor-pointer"
            onClick={onEdit}
          >
