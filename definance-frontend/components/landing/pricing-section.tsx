      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="mx-auto mb-10 max-w-xl text-center">
          ...
          <p className="text-[13px] text-muted-foreground font-medium">
            14 dias de acesso total. Bloqueio automático após o trial.
          </p>
        </div>
          ...
          >
            ...
            <div className="p-8 text-center border-b border-border/50 relative z-10">
               <div className="flex justify-center gap-2 mb-6">
                 ...
                 <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-500 text-[9px] font-semibold uppercase tracking-widest border border-emerald-500/20">14 Dias Trial</span>
               </div>
               ...
               <div className="mt-8 space-y-4">
                  <Button className="w-full h-12 text-[10px] font-semibold uppercase tracking-[0.2em] rounded-xl bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2">
                    Começar agora
            ...
            <div className="p-6 bg-muted/5 relative z-10">
               ...
               <div className="mt-6 text-center">
                  <p className="text-[9px] text-muted-foreground italic opacity-60 leading-tight">
                    Acesso bloqueado automaticamente <br /> após o período de trial de 14 dias.
                  </p>
               </div>
            </div>
          </motion.div>
